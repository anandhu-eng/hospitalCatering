    ...
    <div>
      ...
      <div class="desktop30-container">
        <div class="desktop30-desktop30">
          <span class="desktop30-text"><span>Medimenu</span></span>
          <div class="desktop30-group80">
            <div class="desktop30-group34">
              <div class="desktop30-group14">
                <div class="desktop30-iconamoonprofilecircle">
                  <div class="desktop30-group">
                    <img
                      src="<?php echo asset('homepg/external/')?>/vector1559-4i7f.svg"
                      alt="Vector1551"
                      class="desktop30-vector"
                    />
                    <img
                      src="<?php echo asset('homepg/external/')?>/vector1559-0gk.svg"
                      alt="Vector1551"
                      class="desktop30-vector01"
                    />
                  </div>
                </div>
